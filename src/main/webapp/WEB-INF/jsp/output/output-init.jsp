...
<div class="page-container">
    <div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			...
			<a class="btn btn-primary radius" onclick="output_list('查看出库记录','${basePath}/output-list')"
               href="javascript:;">
    ...
    <form class="form form-horizontal" id="form-output" action="${basePath}/outputSubmit" method="post">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>出库日期:</label>
            <div class=" formControls col-xs-8 col-sm-9">
                <input type="text" name="createStringTime" onfocus="WdatePicker({ dateFmt:'yyyy-MM-dd' })" id="logmin"
        ...
        <div class="row cl">
            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                <button onClick="output_submit()" class="btn btn-primary radius" type="button"><i class="Hui-iconfont">&#xe632;</i>
                    提交
                </button>
...
<script type="text/javascript">
    ...
    /*出库记录查看*/
    function output_list(title, url) {
